...
public struct AsyncHTTPServer: ServiceLifecycle.Service, CustomStringConvertible {
    ...
    public init(port: Int = ServerDefaults.defaultPort,
                defaultLogger: Logger = Logger(label: "com.amazon.ExampleAsyncHTTPServer.AsyncHTTPServer"),
                eventLoopGroup: EventLoopGroup,
                handler: @Sendable @escaping (HTTPServerRequest, HTTPServerResponseWriter) async -> ()) {
        self.port = port
